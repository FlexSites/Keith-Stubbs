...
var app = angular.module("app", [ "ngRoute" ]).config([ "$routeProvider", "$locationProvider", function($routeProvider, $locationProvider) {
    angular.forEach([ {
        ...
        bgClass: "bg-home",
        title: "Utah-based comedian Keith Stubbs"
    }, {
        url: "/bio",
        templateUrl: "/html/bio.html",
        bgClass: "bg-bio",
        title: "About Keith Stubbs"
    }, {
        url: "/contact",
        templateUrl: "/html/contact.html",
        bgClass: "bg-contact",
        title: "Book comedian Keith Stubbs for your Christmas party"
    }, {
        url: "/videos",
        templateUrl: "/html/videos.html",
        bgClass: "bg-media",
        title: "Videos of Keith Stubbs",
        controller: "MediaController"
    }, {
        url: "/calendar",
        templateUrl: "/html/calendar.html",
        bgClass: "bg-calendar",
        title: "See an upcoming performance of Keith Stubbs"
    } ], function(route) {
        var url = route.url;
        delete route.url;
