...
var app = angular.module("comedian", [ "ngRoute" ]).config([ "$routeProvider", "$locationProvider", function($routeProvider, $locationProvider) {
    ...
    $http.get("http://testapi.comedian.io/media").success(function(data) {
    ...
    $http.get("http://testapi.comedian.io/events").success(function() {
        console.log("Success", arguments);
    }).error(function() {
    ...
    $scope.saveData = function() {
        ...
        $http.post("http://testapi.comedian.io/subscribers", $scope.subscriber).success(function(data) {
            that.submitted = true;
    ...
    var that = this;
    $scope.saveData = function() {
        $http.post("http://testapi.comedian.io/mail/send", $scope.contact).success(function(data) {
            that.submitted = true;
            that.message = data.message;
        });
    };
